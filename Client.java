...
public static void main(String[] args) {
        ...
        //PriceCalculator.calculatePrice(microwaveOven); 
         
       
        
        for(HouseholdItem item : householdItmes) {
        	 PriceCalculator v = new PriceCalculator(); 
             v.calculatePrice(item);
             PackingInstructionCalculator w= new PackingInstructionCalculator();
             w.calculateInstructions(item); 
             System.out.println(); 
